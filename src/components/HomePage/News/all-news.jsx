...
const AllNews = ({news}) => {
 ...
 <div className='flex flex-col gap-4 shadow-sm mt-5'>
  ...
  <figure>
          <Image  src={news?.image_url} width={300}   height={200} alt={news.title} loading='eager' className='w-full px-2' />
  </figure>
     
     <p className='py-4 text-sm text-md font-semibold px-2 line-clamp-2'> {news?.details} </p>
</div>
